export default class NavButton {
    static checkInstanceMethodError (arg) {
        ...
        if (typeof arg !== "string" || typeof arg !== "number") {
            throw new TypeError(`Invalid argument type ${typeof arg}. Expected string or number`);
        }
    }
    ...
    static checkClassMethodError (arg1, arg2) {
        ...
        if (!(arg1 instanceof HTMLElement)) {
            throw new TypeError (`Invalid argument type: ${arg1}. Expected HtmlElement.`);
        }
        if (typeof arg2 !== "string" && typeof arg2 !== "number") {
            throw new TypeError(`Invalid argument type ${typeof arg2}. Expected string or number`);
        }
    }
    ...
    static onClick(btn, callback) {
        ...
        if (!(btn instanceof HTMLElement)) {
            throw new TypeError (`Invalid argument type: ${btn}. Expected HtmlElement.`);
        } 
        if (typeof callback !== 'function') {
            throw new TypeError (`Invalid argument type: ${callback}.Expected function.`);
        }
    ...
    appendButton(container) {
        ...
        if (!(container instanceof HTMLElement)) {
            throw new TypeError (`Invalid argument type: ${container}. Expected HtmlElement.`);
        }
